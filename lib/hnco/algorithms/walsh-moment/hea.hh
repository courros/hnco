 ...
 * Reference:
 *
 * Arnaud Berny. 2015. Herding Evolutionary %Algorithm. In Proceedings
 * of the Companion Publication of the 2015 Annual Conference on
 * Genetic and Evolutionary Computation (GECCO Companion ’15). ACM,
 * New York, NY, USA, 1355–1356.
 */
...
public:
  ...
  void set_bound_moment(bool b) { _bound_moment = b; }
  /// Randomize bit order
