...
void HncoOptions::print_help_fn(std::ostream& stream) const
{
  ...
  stream << "            182: Complex multivariate function (rep: bv -> complex | parser: [complex] -> complex | z -> std::norm(z))" << std::endl;
  ...
  stream << "            210: Real multivariate equation (rep: bv -> double | parser: [double] -> double | x -> -std::fabs(x))" << std::endl;
  stream << "            211: Integer multivariate equation (rep: bv -> long | parser: [long] -> long | n -> -std::fabs(n))" << std::endl;
  stream << "            212: Complex multivariate equation (rep: bv -> complex | parser: [complex] -> complex | z -> -std::norm(z))" << std::endl;
  stream << "            213: Integer multivariate equation (rep: bv -> int | cast to double | parser: [double] -> double | x -> -std::fabs(x))" << std::endl;
  stream << "            214: Mixed-representation multivariate equation (rep: bv -> long, double, or set | parser: [double] -> double | x -> -std::fabs(x))" << std::endl;
