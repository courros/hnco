...
void HncoOptions::print_help_fn(std::ostream& stream) const
{
  ...
  stream << "            182: Complex multivariate function (rep: bv -> complex | parser: [complex] -> complex | z -> |z|^2)" << std::endl;
  ...
  stream << "            210: Real multivariate equation (rep: bv -> double | parser: [double] -> double | x -> -|x|)" << std::endl;
  stream << "            211: Integer multivariate equation (rep: bv -> long | parser: [long] -> long | x -> -|x|)" << std::endl;
  stream << "            212: Complex multivariate equation (rep: bv -> complex | parser: [complex] -> complex | z -> -|z|^2)" << std::endl;
  stream << "            213: Integer multivariate equation (rep: bv -> int | cast to double | parser: [double] -> double | x -> -|x|)" << std::endl;
  stream << "            214: Mixed-representation multivariate equation (rep: bv -> long, double, or set | parser: [double] -> double | x -> -|x|)" << std::endl;
