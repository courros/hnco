...
public:
  ...
  */
  void load(std::string path) {
    ...
    if (!stream.good())
      throw std::runtime_error("LinearFunction::load: Cannot open " + path);
    try {
      boost::archive::text_iarchive archive(stream);
      archive >> (*this);
    }
    catch (boost::archive::archive_exception& e) {
      throw std::runtime_error("LinearFunction::load: " + std::string(e.what()));
    }
  }
  ...
  */
  void save(std::string path) const {
    ...
    try {
      ...
      throw std::runtime_error("LinearFunction::save: " + std::string(e.what()));
    }
  }
