 ...
 * Reference:
 *
 * Heinz Mühlenbein, "How genetic algorithms really work: I. mutation
 * and hillclimbing", in Proc. 2nd Int. Conf. on Parallel Problem
 * Solving from Nature, 1992
 */
 ...
 * Reference:
 *
 * R. J. Quick, V. J. Rayward-Smith, and G. D. Smith. Fitness distance
 * correlation and %Ridge functions. Parallel Problem Solving from
 * Nature --- PPSN V, Springer Berlin Heidelberg, 1998.
 */
