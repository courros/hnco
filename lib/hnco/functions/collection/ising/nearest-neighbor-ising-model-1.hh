...
public:
  ...
  */
  void load(std::string path) { load_from_archive(*this, path, "NearestNeighborIsingModel1"); }
  ...
  /** Save instance.
      ...
      \throw std::runtime_error
  */
  void save(std::string path) const { save_to_archive(*this, path, "NearestNeighborIsingModel1"); }
